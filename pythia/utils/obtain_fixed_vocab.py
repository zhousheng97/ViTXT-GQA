...
class FixedVocab:
    def __init__(self, args):
        ...
        fixed_ans_path = '/data/zsheng/Data_T5_ViteVQA/data/{}/{}'.format(dataset, fixed_ans_path)
        with open('/data/zsheng/Data_T5_ViteVQA/data/fixed_answer_vocab_'+ args.setting +'.txt', 'w+', encoding='utf-8') as f:
